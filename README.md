...
- [DNA Chip Coverage](https://github.com/AndreySoloviev/dna-chip-coverage) — Marker-level coverage of consumer DNA genotyping arrays: 70 clinically discussed SNPs against 5 published Illumina arrays and 9 consumer products (980 rows), derived from public array manifests and dbSNP coordinates with a reproducible build script (CC BY 4.0).
